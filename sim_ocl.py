...
from nengo_ocl.clra_nonlinearities import (
    ...
    init_rng, get_dist_enums_params, plan_whitenoise, plan_whitesignal, plan_adaptive_lif_rate)
...
class Simulator(sim_npy.Simulator):
    ...
    def _plan_AdaptiveLIFRate(self, ops):
        ...
        return [plan_adaptive_lif_rate(self.queue, J, R, ref, tau, dt, tau_adapt, inc, n_elements=2)]    
    ...
    def plan_SimVoja(self,ops):
        logging.info("Voja rule not implemented, pass")
        return []
